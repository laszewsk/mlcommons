...
=== Hyperparameters and Optimizer UNO
...
|===
| Model | Name | Constraint | Definition | Reference Code 
| UNO | num_epochs| `value > 0` | num_epochs | config 
| UNO | learning_rate| `value > 0.0`. Example: `0.001` | learning_rate | config 
| UNO | batch_size| `value > 0`.Example: `32` | Batch size | config
| UNO | train_split| `value = 0.8` | Ratio of splitting the dataset into training and testing data | config
|===
