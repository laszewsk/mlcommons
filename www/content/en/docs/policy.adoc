...
| Earth Quake Prediction | TBD | Normalized Nash–Sutcliffe model efficiency (NNSE), 0.8<NNSE<0.99
| CloudMask | TBD | convergence target 0.9
| STEMDL Classification | TBD | convergence target 0.9
| UNO | TBD | Score: 0.0054
|===
