...
def cloud_inference(args)-> None:
    ...
    print ("MODEL PATH GGGG", modelPath) 
...
def main():
    ...
    print(f"CloudMask training, samples = {samples}, epochs={args['epochs']}, bs={args['batch_size']}, nodes={args['nodes']}, gpus={args['gpu']}, time_per_epoch={time_per_epoch_str}\n")
