#!/usr/bin/env bash
#SBATCH --job-name=mlcommons-eq-rtx3090-1
...
#SBATCH --mail-user=laszewski@gmail.com
...
MLCOMMONS_HOME=${MLCOMMONS_HOME:-/project/eq/runner/mlcommons}
...
echo "Revision: <${REV}>"
echo "Script: <FFFFWNPFEARTHQ_newTFTv29-gregor-parameters-fig.ipynb>"
...
waitmake_lock mlcommons.git
    ...
    mkdir -p ${NB_OUTPUT}
    cp ${GIT_BASEPATH}/mlcommons/benchmarks/earthquake/${REV}/FFFFWNPFEARTHQ_newTFTv29-gregor-parameters-fig.ipynb \
